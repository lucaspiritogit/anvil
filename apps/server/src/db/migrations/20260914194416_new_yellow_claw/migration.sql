ALTER TABLE `tasks` ADD `review_policy` text DEFAULT 'review_each_issue' NOT NULL;--> statement-breakpoint
...
INSERT INTO `__new_tasks`(`id`, `style`, `workspace_id`, `project_id`, `agent_id`, `agent_label`, `model`, `prompt`, `title`, `cwd`, `status`, `started_at`, `ended_at`, `working_time_ms`, `working_started_at`, `reviewed_at`, `settled_at`, `exit_code`, `error`, `input_tokens`, `output_tokens`, `cached_tokens`, `total_tokens`, `cost_usd`, `delivery_status`, `parent_task_id`, `expected_files`, `restack_state`, `restack_target`, `stack_suggestion`, `base_branch`, `branch_name`, `base_commit`, `head_commit`, `files_changed`, `additions`, `deletions`, `delivery_error`, `context_used`, `context_size`, `context_compaction_error`, `session_id`) SELECT `id`, `style`, `workspace_id`, `project_id`, `agent_id`, `agent_label`, `model`, `prompt`, `title`, `cwd`, `status`, `started_at`, `ended_at`, `working_time_ms`, `working_started_at`, `reviewed_at`, `settled_at`, `exit_code`, `error`, `input_tokens`, `output_tokens`, `cached_tokens`, `total_tokens`, `cost_usd`, `delivery_status`, `parent_task_id`, `expected_files`, `restack_state`, `restack_target`, `stack_suggestion`, `base_branch`, `branch_name`, `base_commit`, `head_commit`, `files_changed`, `additions`, `deletions`, `delivery_error`, `context_used`, `context_size`, `context_compaction_error`, `session_id` FROM `tasks`;--> statement-breakpoint
