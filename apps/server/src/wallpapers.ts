...
import { isWallpaperId } from '@anvil/protocol/appearance'
import type { Wallpaper, WallpaperUpload } from '@anvil/protocol/types'
...
/** A flat local library with validated image imports. */
export class WallpaperLibrary {
  ...
  // Serialize reads so concurrent requests cannot multiply image buffer memory.
  ...
  /** Import a local file after validating its format and dimensions. */
