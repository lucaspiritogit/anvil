...
import type { CaffeineActivity, CaffeineState } from '@anvil/protocol/caffeine'
import { isBrowserHostRequest, type BrowserHostRequest, type BrowserHostResponse } from '@anvil/protocol/browser-host'
