...
export const btn = {
  primary:
    'px-3.5 py-[7px] rounded-md font-medium whitespace-nowrap bg-accent text-canvas disabled:opacity-45 disabled:cursor-not-allowed',
  ghost: 'px-3 py-[7px] rounded-md border border-line text-dim hover:text-fg',
  danger: 'px-3 py-[5px] rounded-md border border-line text-danger',
  icon: 'size-[22px] rounded-[5px] text-[15px] leading-none text-dim hover:text-fg hover:bg-hover',
 ...
 */
const CONTROL =
  'w-full rounded-md bg-canvas text-fg border border-line outline-none focus:border-accent'
...
export const modal = {
  ...
  panel: 'max-h-[88vh] p-5 overflow-y-auto bg-raised border border-line rounded-card',
  width: {
  ...
  toggle: 'flex gap-2.5 items-start p-3 mt-0.5 mb-3 border border-line rounded-md'
}
...
export const card = 'p-[18px] bg-raised border border-line rounded-card'
