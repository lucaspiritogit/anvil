export const SETTINGS_SECTIONS = [
  ...
  { id: 'providers', icon: 'brain-circuit', label: 'Providers', description: 'Choose the default agent and model for your tasks.' },
  ...
  { id: 'connections', icon: 'waypoints', label: 'Connections', description: 'Control LAN and Tailscale access to Anvil.' },
