...
import { BROWSER_VIEWPORTS, clampBrowserZoom, type BrowserObservationLayout, type BrowserObservationState, type BrowserViewport } from '@anvil/protocol/browser-observation'
